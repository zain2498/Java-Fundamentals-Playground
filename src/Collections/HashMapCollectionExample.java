...
public class HashMapCollectionExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Extracting values based on keys: " + keys);
        for (int key : keys) {
     ...
     * eik key paas krdi jati ha hash function me jise hashcode generate huta ha or hashcode ki help se hamen pata chalta ha
     * k key value ko kaha store krna ha array me
     * calculating index :
